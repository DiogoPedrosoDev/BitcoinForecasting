...
plt.plot(df.index[:train_length], df['Close'][:train_length], label='Training', color='blue')
plt.plot(df.index[train_length:], df['Close'][train_length:], label='Test', color='red')
...
# Achata os dados para 2D
y_true = y_true.reshape(y_true.shape[0], -1)
y_pred = y_pred.reshape(y_pred.shape[0], -1)

# Desnormaliza com o mesmo scaler usado no início
